...
- You must always use relative imports for imports within the `freezer` (internal imports must
  be relative).
...
Also you can see the latest formatting rules on the [analysis_options.yaml](https://github.com/myConsciousness/freezer/blob/main/analysis_options.yaml)!
